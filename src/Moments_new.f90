module Moments
!-------------------------------------------------------------------------------
! This module contains all the multipole moments Qlm of the nuclear wavefunction
! and the subroutines to calculate them. Note that this includes the rms-radius
! as multipole moment of l=-2  and the routines that special constraints
...
contains
  ...
  subroutine PrintMomentInfo()
    ...
    5 format ('  Total permutation    : ',22x, '(', a1, ',', a1, ',', a1, ')')
  ...
  subroutine PrintConstraints
    ...
    4   format ('RMS Radius ', 1(1x,f10.2), 7x, A19)
    41  format ('RMS Radius ', 2(1x,f10.2), 7x, A19)
    411 format ('RMS Radius ', 1(1x,f10.2), 7x, A19)

    5    format (A2, " Q_{", 2i2,"}", 1(1x,f10.2), 6x, a19)
    51   format (A2, " Q_{", 2i2,"}", 2(1x,f10.2), 6x, a19)
    511  format (A2, " Q_{", 2i2,"}", 1(1x,f10.2), 6x, a19)
    5111 format (A2, " Q_{",  i2,"}", 2x, 1(1x,f10.2), 6x, a19)

    type(Moment), pointer :: Current
    character(len=2)      :: ReIm
    character(len=19)      :: ConType
    ...
    case (2)
     ...
     case(1)
      ...
      if(.not. ToReadjust%total) then
        ...
        O2 = sum(CalculateTotalQl(Toreadjust%l))**2
        ...
        print *, 'Old', Old
        print *, 'O2', O2
        print *, 'Total', sum(CalculateTotalQl(Toreadjust%l))
        print *, ToReadjust%Intensity
        print *,  epsilon*                 &
        & (sum(CalculateTotalQl(Toreadjust%l))-sum(Old))/(O2(1) + d0)
      endif
